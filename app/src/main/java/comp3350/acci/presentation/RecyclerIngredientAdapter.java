...
public class RecyclerIngredientAdapter extends RecyclerView.Adapter<RecyclerIngredientAdapter.ViewHolder> {
    ...
    RecyclerIngredientAdapter(Context context, ArrayList<IngredientModel> arrayIngredients){
...
//                editName.setText(arrIngredients.get(position).name);
//                editquantity.setText(arrIngredients.get(position).quantity);
//
...
//                        }
//
//                        arrIngredients.set(position, new IngredientModel(name, quantity));
